...
let api_list_front = resolve => require(['../components/module/api_list_front.vue'], resolve)
let api_list_back = resolve => require(['../components/module/api_list_back.vue'], resolve)
let change_api = resolve => require(['../components/module/change_api.vue'], resolve)
